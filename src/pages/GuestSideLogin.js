...
const GuestSideLogin = ({ socket }) => {
    ...
    const handleScan = (data) => {
        if (data) {
            setQRCode(data); // Set scanned QR code to state
        ...
        <div className={styles.qrisReaderContainer}>
            <div className={styles.qrScannerContainer}>
                <QrReader
                    ...
                    delay={500} // Adjust scan delay as needed
                    onResult={handleScan}
                    videoId="video" // ID for the video element
                    className={styles.qrReader} // Apply module CSS class
                    videoContainerStyle={{ width: '100vw', height: '100vh', paddingTop: '0px' }} // Full-screen video container
                    videoStyle={{ width: '100%', height: '100%' }} // Full-screen video
                />
